  ...
  const qualities = [
    {
      ...
      description:
        "Consistently approaches complex software challenges with analytical rigor and persistence, leveraging a solid foundation in algorithms, system design, and backend architecture.",
    },
    {
      icon: <BookOpenIcon className="w-6 h-6" />,
      title: "Continuous Learner",
      description:
        "Deeply committed to personal and professional growth—actively mastering modern technologies, exploring applied AI, and staying current with industry trends to build better, smarter solutions.",
    },
    {
    ...
    },
    {
      ...
      title: "Practically Oriented",
      description:
        "Focused on building impactful solutions, while sharpening expertise in applied AI and system design.",
    },
  ];

  return (
    <div
      className="py-20 px-4 sm:px-6 md:px-12 relative overflow-hidden"
      id="about"
    >
      {/* Background shape */}
              ...
              <div className="relative bg-surface-light dark:bg-surface-dark p-6 rounded-lg shadow-xl">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <p className="font-medium text-gray-700 dark:text-gray-200">
                    Currently working with Reliance Jio and Pursuing my passion
                    for AI and LLMS.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            >
              <p className="text-lg text-gray-600 dark:text-gray-300">
                ...
                through code and building applications that provide genuine
                value.
              </p>
            </motion.div>
          </motion.div>
