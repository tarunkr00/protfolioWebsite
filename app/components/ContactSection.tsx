...
const ContactSection: React.FC<ContactProps> = ({ contact, location }) => {
  ...
  useEffect(() => {
    emailjs.init("qzWvXRL6l5G25gJZ4"); // Replace with your actual public key
  }, []);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await emailjs.send(
        "service_42pv76k", // Replace with your actual service ID
        "template_73yae0s", // Replace with your actual template ID
        {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <motion.button
                    ...
                    whileTap={
                      formStatus !== "submitting" ? { scale: 0.98 } : {}
                    }
                  >
                    {formStatus === "submitting" ? (
